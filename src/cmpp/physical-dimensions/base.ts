...
export type Time_ = Seconds | TicksOfClock

export const Time_ = (value: number, kind: Time_['kind']): Time_ => {
    switch (kind) {
        case 'TicksOfClock': return TicksOfClock(value);
...
export type Position = Pulses | Milimeters

export const Position = (value: number, kind: Position['kind']): Position => {
    switch (kind) {
        case 'Pulses': return Pulses(value);
        case 'Milimeters': return Milimeters(value)
        default:
            assertUnreachable(kind)
    }
}
...
export type Velocity = { kind: 'Velocity', numerator: Position, denominator: Time_ }

export const Velocity = ( numerator: Position, denominator: Time_ ): Velocity => ({kind: 'Velocity', numerator, denominator})



export type Acceleration = { kind: 'Acceleration', numerator: Velocity, denominator: Time_ }

export const Acceleration = (numerator: Velocity, denominator: Time_ ): Acceleration => ({kind: 'Acceleration', numerator, denominator})
