...
test('can list serial ports (depends on com0com be installed)', () => {
...
test('can open serial port (depends on com0com be installed)', async () => {
...
test('can open two independent loop-backed ports and send data bidirectionally (depends on com0com be installed)', async () => {
