...
export const setNext = async (cmppControler: CmppControler, next: PositionInPulses & Kinematics) => {
...
export const goNext = async (cmppControler: CmppControler, next: PositionInPulses & Kinematics) => {
...
export const setNextRelative = async (cmppControler: CmppControler, next: PositionInPulses & Kinematics) => {
...
export const goNextRelative = async (cmppControler: CmppControler, next: PositionInPulses & Kinematics) => {
